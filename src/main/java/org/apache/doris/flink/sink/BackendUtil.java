...
public class BackendUtil {
    ...
    private final List<BackendRowV2> backends;
    private long pos;

    public BackendUtil(List<BackendRowV2> backends) {
    ...
    private List<BackendRowV2> initBackends(String beNodes) {
