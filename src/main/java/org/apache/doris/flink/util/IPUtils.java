...
public class IPUtils {
    /**
     * Create an IPv6 address from a (positive) {@link BigInteger}. The magnitude of the
     * {@link BigInteger} represents the IPv6 address value. Or in other words, the {@link
     * BigInteger} with value N defines the Nth possible IPv6 address.
     *
